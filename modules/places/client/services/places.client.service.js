...
angular.module('digitalInclusion.places').factory('gservice', function($rootScope, $http) {
 ...
 var thisLocation = getLocation();
  ...
  var selectedLat = thisLocation.lat;
  var selectedLong = thisLocation.lng;
  googleMapService.refresh = function(latitude, longitude, filteredResults){
        ...
        var convertToMapPoints = function(response){
            ...
            for(var i= 0; i < response.length; i++) {
                ...
                var  contentString = '<p><b>Name</b>: ' + place.title + '<br><b>Address</b>: ' + place.readableAddress + '<br>' +
                    '<b>Category</b>: ' + place.primaryCategory + '<br><b>Description/b>: ' + place.description + '</p>';
        ...
        var Location = function(latlon, message, name, address, description, category){
            this.latlon = latlon;
