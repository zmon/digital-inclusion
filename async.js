                         ...
                         googlePlaces = new GooglePlaces("AIzaSyBP-nR1enubXspfTSfSit1tYwT4ZSwRi-s", "json"),
                           ...
                           lineReader = require('readline').createInterface({
                            ...
                            locations = [],
                                 ...
                                 tmp2 = [],
                                 tmp3 = [],
                           downstream = fs.createReadStream(dest),
...
//   console.log("++  **  ^^  %%  $$  --");
//   console.log("lineReader3: " + line);
// });

lineReader3.eachLine('modules/core/client/map-data/data.json', function(line, last) {
  console.log("^^^^^^^");
  console.log(line);
});

// var writeToCurrent = function() {
//   return gta;
// };
...
var callback = function(arr, index) {
...
var encode = function(index, obj) {
  ...
  // increment(index);
  // geocode(obj);
  // tmp1.push({index:index, data:obj});
  tmp2.push(obj);
  checkLimit(index);
...
var geocode = function(arr) {
  ...
  forEach(arr, function(item, index) {
    ...
    // console.log("Services: " + parsedJson.services);
    ...
    // parsedJson.google_data = {};
    // parsedJson.google_data.bounds = {};
    // parsedJson.google_data.bounds.northeast = {};
  ...
  // console.log(tmp3);/
    // console.log(parsedJson);
    // console.log("parsed and geocoded: " + parsedJson.google_data.bounds.northeast);
